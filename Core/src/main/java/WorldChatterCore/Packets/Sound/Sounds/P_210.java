...
public enum P_210 {
    ...
    MOB_HUSK_IDLE("MOB_HUSK_IDLE", "entity.husk.ambient"),
    MOB_HUSK_HURT("MOB_HUSK_HURT", "entity.husk.hurt"),
    MOB_HUSK_DEATH("MOB_HUSK_DEATH", "entity.husk.death"),
    MOB_HUSK_STEP("MOB_HUSK_STEP", "entity.husk.step"),

    MOB_STRAY_IDLE("MOB_STRAY_IDLE", "entity.stray.ambient"),
    MOB_STRAY_HURT("MOB_STRAY_HURT", "entity.stray.hurt"),
    MOB_STRAY_DEATH("MOB_STRAY_DEATH", "entity.stray.death"),
    MOB_STRAY_STEP("MOB_STRAY_STEP", "entity.stray.step"),
    ...
    public static final ImmutableMap<String, P_210> STRING_TO_SOUND_CONSTANT;

    P_210(final String keyName, final String soundName) {
        this.keyName = keyName;
        this.soundName = soundName;
    }

    public static String getSound(final String name) {
        final P_210 sound = STRING_TO_SOUND_CONSTANT.get(name);

        return sound != null ? sound.soundName : name;
    }

    static {
        final Map<String, P_210> versions = new HashMap<>();

        for (final P_210 sound : values()) {
